...
const dateDiff = (date1, date2) => {
    let newDate1 = new Data(date1);
    let newDate2 = new Data(date2);
    let dateResult = Math.abs(newDate1 - newDate2);
    let days = Math.ceil(dateResult / (1000 * 60 * 60 * 24));
    return days;
};
